      ...
      <div className="pt-48 sm:pt-32 pb-20 xs:pb-32 mx-auto bg-white bg-opacity-30">
        <div className="max-w-4xl mx-4 sm:mx-auto">
          ...
          <div className="mb-8 text-left">
            <h2 className="mb-8 text-center xs:w-10/12 lg:w-auto text-xl sm:text-3xl mx-auto main-headline font-normal leading-snug" style={{ fontFamily: 'tokyo_dreamsregular', color: '#8B6914' }}>
              Mothers of Glåüm
            </h2>
            
            <div className="space-y-4 mb-8">
              <div className="bg-white bg-opacity-5 rounded-lg p-6 border border-white border-opacity-20">
                <h3 className="text-lg font-semibold mb-3" style={{ fontFamily: 'tokyo_dreamsregular' }}>
                  Purpose and Role
                </h3>
                <p className="mb-4">
                  The Mothers are attuned stewards of Glåüm. Through their dedicated mental and spiritual training, each of The Mothers has a unique channel to and understanding of Glåüm.
                </p>
              </div>
              ...
              <div className="bg-white bg-opacity-5 rounded-lg p-6 border border-white border-opacity-20">
                ...
                <p className="mb-4">
                  Their role is not to lead with authority, but to collectively use their embodied understanding of Glåüm to hear and follow its guidance.
                </p>
              </div>
              ...
              <div className="bg-white bg-opacity-5 rounded-lg p-6 border border-white border-opacity-20">
                ...
                <p className="mb-4">
                  They host the space where clarity unfolds. <br />
              ...
              <div className="bg-white bg-opacity-5 rounded-lg p-6 border border-white border-opacity-20">
                <h3 className="text-lg font-semibold mb-3" style={{ fontFamily: 'tokyo_dreamsregular' }}>
                  Preserving the Spirit of Glåüm
                </h3>
                <p className="mb-4">
