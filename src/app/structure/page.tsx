...
export const metadata: Metadata = {
  ...
  description: 'Mothers of Glåüm and Council of Attunement - The structure and governance of the Glåüm community. Learn about the matriarchal council and policies for harm and disruption.',
  keywords: [
    'Glåüm Structure',
    'Mothers of Glåüm',
  ...
  openGraph: {
    title: 'Glåüm Structure | Governance and Community Organization',
    description: 'Mothers of Glåüm and Council of Attunement - The structure and governance of the Glåüm community. Learn about the matriarchal council and policies for harm and disruption.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Glåüm Structure - Governance and Community Organization',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  twitter: {
    ...
    images: ['/img/structure.png'],
  },
  alternates: {
    canonical: `${PRIMARY_DOMAIN}/structure`, // Always use primary domain for canonical URLs
  },
  robots: {
    index: true,
    follow: true,
